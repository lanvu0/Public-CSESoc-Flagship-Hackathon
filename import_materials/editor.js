document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ensure the Import Materials button doesn't stand out
    document.getElementById('docImportBtn').classList.remove('active'); // Remove if accidentally added

    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('docImportBtn').classList.add('active');
    });
});